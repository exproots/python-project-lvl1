...
def get_game_round():
    ...
    numbers_progression = [first_number, number_prog2, number_prog3, number_prog4, number_prog5, number_prog6, number_prog7, number_prog8, number_prog9, number_prog10]
